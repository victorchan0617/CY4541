...
module SCB_P4_v3_10_1 (
	...
	cy_psoc3_pins_v1_10
		#(.id("88d181cc-d89b-4924-a61a-a0c6bd2c6c63/5382e105-1382-4a2e-b9f4-3bb2feba71e0"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("88d181cc-d89b-4924-a61a-a0c6bd2c6c63/22863ebe-a37b-476f-b252-6e49a8c00b12"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
...
// SW_Tx_UART_v1_50(BaudRate=115200, PinAssignmentMethod=1, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=SW_Tx_UART_v1_50, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=UART, CY_INSTANCE_SHORT_NAME=UART, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=50, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 DP1, INSTANCE_NAME=UART, )
module SW_Tx_UART_v1_50_3 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("388a5837-eec7-4183-9266-5db0beed00d6/52f31aa9-2f0a-497d-9a1f-1424095e13e6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
...
module top ;
	...
	wire [0:0] tmpOE__VBUS_DISCHARGE_P1_net;
	wire [0:0] tmpFB_0__VBUS_DISCHARGE_P1_net;
	wire [0:0] tmpIO_0__VBUS_DISCHARGE_P1_net;
	wire [0:0] tmpINTERRUPT_0__VBUS_DISCHARGE_P1_net;
	electrical [0:0] tmpSIOVREF__VBUS_DISCHARGE_P1_net;

	cy_psoc3_pins_v1_10
		#(.id("c90cdabd-3d72-4a08-bf7f-1d3389033d68"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		VBUS_DISCHARGE_P1
		 (.oe(tmpOE__VBUS_DISCHARGE_P1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__VBUS_DISCHARGE_P1_net[0:0]}),
		  .io({tmpIO_0__VBUS_DISCHARGE_P1_net[0:0]}),
		  .siovref(tmpSIOVREF__VBUS_DISCHARGE_P1_net),
		  .interrupt({tmpINTERRUPT_0__VBUS_DISCHARGE_P1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__VBUS_DISCHARGE_P1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__VBUS_P_CTRL_P2_net;
	wire [0:0] tmpFB_0__VBUS_P_CTRL_P2_net;
	wire [0:0] tmpIO_0__VBUS_P_CTRL_P2_net;
	wire [0:0] tmpINTERRUPT_0__VBUS_P_CTRL_P2_net;
	electrical [0:0] tmpSIOVREF__VBUS_P_CTRL_P2_net;

	cy_psoc3_pins_v1_10
		#(.id("eca81861-7cd4-471c-b508-ddf83add96fa"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		VBUS_P_CTRL_P2
		 (.oe(tmpOE__VBUS_P_CTRL_P2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__VBUS_P_CTRL_P2_net[0:0]}),
		  .io({tmpIO_0__VBUS_P_CTRL_P2_net[0:0]}),
		  .siovref(tmpSIOVREF__VBUS_P_CTRL_P2_net),
		  .interrupt({tmpINTERRUPT_0__VBUS_P_CTRL_P2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__VBUS_P_CTRL_P2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__VBUS_C_CTRL_P2_net;
	wire [0:0] tmpFB_0__VBUS_C_CTRL_P2_net;
	wire [0:0] tmpIO_0__VBUS_C_CTRL_P2_net;
	wire [0:0] tmpINTERRUPT_0__VBUS_C_CTRL_P2_net;
	electrical [0:0] tmpSIOVREF__VBUS_C_CTRL_P2_net;

	cy_psoc3_pins_v1_10
		#(.id("3eda1e0d-4963-4219-b24b-1d2f0fa4f2ab"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		VBUS_C_CTRL_P2
		 (.oe(tmpOE__VBUS_C_CTRL_P2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__VBUS_C_CTRL_P2_net[0:0]}),
		  .io({tmpIO_0__VBUS_C_CTRL_P2_net[0:0]}),
		  .siovref(tmpSIOVREF__VBUS_C_CTRL_P2_net),
		  .interrupt({tmpINTERRUPT_0__VBUS_C_CTRL_P2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__VBUS_C_CTRL_P2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__VBUS_DISCHARGE_P2_net;
	wire [0:0] tmpFB_0__VBUS_DISCHARGE_P2_net;
	wire [0:0] tmpIO_0__VBUS_DISCHARGE_P2_net;
	wire [0:0] tmpINTERRUPT_0__VBUS_DISCHARGE_P2_net;
	electrical [0:0] tmpSIOVREF__VBUS_DISCHARGE_P2_net;

	cy_psoc3_pins_v1_10
		#(.id("4a09cc08-a42c-4815-b7e8-0fe0406dffa5"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		VBUS_DISCHARGE_P2
		 (.oe(tmpOE__VBUS_DISCHARGE_P2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__VBUS_DISCHARGE_P2_net[0:0]}),
		  .io({tmpIO_0__VBUS_DISCHARGE_P2_net[0:0]}),
		  .siovref(tmpSIOVREF__VBUS_DISCHARGE_P2_net),
		  .interrupt({tmpINTERRUPT_0__VBUS_DISCHARGE_P2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__VBUS_DISCHARGE_P2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__VBUS_MON_P2_net;
	wire [0:0] tmpFB_0__VBUS_MON_P2_net;
	wire [0:0] tmpIO_0__VBUS_MON_P2_net;
	wire [0:0] tmpINTERRUPT_0__VBUS_MON_P2_net;
	electrical [0:0] tmpSIOVREF__VBUS_MON_P2_net;

	cy_psoc3_pins_v1_10
		#(.id("3136b928-d2e3-4576-928f-ba6102a6793c"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		VBUS_MON_P2
		 (.oe(tmpOE__VBUS_MON_P2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__VBUS_MON_P2_net[0:0]}),
		  .analog({Net_2225}),
		  .io({tmpIO_0__VBUS_MON_P2_net[0:0]}),
		  .siovref(tmpSIOVREF__VBUS_MON_P2_net),
		  .interrupt({tmpINTERRUPT_0__VBUS_MON_P2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__VBUS_MON_P2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    SCB_P4_v3_10_0 HPI_IF (
        .interrupt(Net_2226),
        .clock(1'b0),
        .rx_tr_out(Net_2228),
        .tx_tr_out(Net_2229));
	...
	wire [0:0] tmpOE__VSEL2_P2_net;
	wire [0:0] tmpFB_0__VSEL2_P2_net;
	wire [0:0] tmpIO_0__VSEL2_P2_net;
	wire [0:0] tmpINTERRUPT_0__VSEL2_P2_net;
	electrical [0:0] tmpSIOVREF__VSEL2_P2_net;

	cy_psoc3_pins_v1_10
		#(.id("8907483a-a4cb-4ba1-9871-f3bbc1900f49"),
		  .drive_mode(3'b101),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		VSEL2_P2
		 (.oe(tmpOE__VSEL2_P2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__VSEL2_P2_net[0:0]}),
		  .io({tmpIO_0__VSEL2_P2_net[0:0]}),
		  .siovref(tmpSIOVREF__VSEL2_P2_net),
		  .interrupt({tmpINTERRUPT_0__VSEL2_P2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__VSEL2_P2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__VSEL1_P2_net;
	wire [0:0] tmpFB_0__VSEL1_P2_net;
	wire [0:0] tmpIO_0__VSEL1_P2_net;
	wire [0:0] tmpINTERRUPT_0__VSEL1_P2_net;
	electrical [0:0] tmpSIOVREF__VSEL1_P2_net;

	cy_psoc3_pins_v1_10
		#(.id("ceb0b0e5-d737-4ec2-b6dc-816dd3d705b8"),
		  .drive_mode(3'b101),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		VSEL1_P2
		 (.oe(tmpOE__VSEL1_P2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__VSEL1_P2_net[0:0]}),
		  .io({tmpIO_0__VSEL1_P2_net[0:0]}),
		  .siovref(tmpSIOVREF__VSEL1_P2_net),
		  .interrupt({tmpINTERRUPT_0__VSEL1_P2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__VSEL1_P2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    SCB_P4_v3_10_1 MUX_CTRL (
        .interrupt(Net_2242),
        .clock(1'b0),
        .rx_tr_out(Net_2244),
        .tx_tr_out(Net_2245));

	wire [0:0] tmpOE__OCP_FAULT_P1_net;
	wire [0:0] tmpIO_0__OCP_FAULT_P1_net;
	wire [0:0] tmpINTERRUPT_0__OCP_FAULT_P1_net;
	electrical [0:0] tmpSIOVREF__OCP_FAULT_P1_net;

	cy_psoc3_pins_v1_10
		#(.id("1b462b7f-6fae-42bd-a796-9f57f799a4be"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		OCP_FAULT_P1
		 (.oe(tmpOE__OCP_FAULT_P1_net),
		  .y({1'b0}),
		  .fb({Net_2246}),
		  .io({tmpIO_0__OCP_FAULT_P1_net[0:0]}),
		  .siovref(tmpSIOVREF__OCP_FAULT_P1_net),
		  .interrupt({tmpINTERRUPT_0__OCP_FAULT_P1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__OCP_FAULT_P1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__OCP_FAULT_P2_net;
	wire [0:0] tmpIO_0__OCP_FAULT_P2_net;
	wire [0:0] tmpINTERRUPT_0__OCP_FAULT_P2_net;
	electrical [0:0] tmpSIOVREF__OCP_FAULT_P2_net;

	cy_psoc3_pins_v1_10
		#(.id("d9c4ec24-20cb-49af-99e9-3b559c8ea70e"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		OCP_FAULT_P2
		 (.oe(tmpOE__OCP_FAULT_P2_net),
		  .y({1'b0}),
		  .fb({Net_2247}),
		  .io({tmpIO_0__OCP_FAULT_P2_net[0:0]}),
		  .siovref(tmpSIOVREF__OCP_FAULT_P2_net),
		  .interrupt({tmpINTERRUPT_0__OCP_FAULT_P2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__OCP_FAULT_P2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__VCONN_MON_P1_net;
	wire [0:0] tmpFB_0__VCONN_MON_P1_net;
	wire [0:0] tmpIO_0__VCONN_MON_P1_net;
	wire [0:0] tmpINTERRUPT_0__VCONN_MON_P1_net;
	electrical [0:0] tmpSIOVREF__VCONN_MON_P1_net;

	cy_psoc3_pins_v1_10
		#(.id("259ce99d-be5c-4103-bf96-e2e36232587b"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		VCONN_MON_P1
		 (.oe(tmpOE__VCONN_MON_P1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__VCONN_MON_P1_net[0:0]}),
		  .analog({Net_2248}),
		  .io({tmpIO_0__VCONN_MON_P1_net[0:0]}),
		  .siovref(tmpSIOVREF__VCONN_MON_P1_net),
		  .interrupt({tmpINTERRUPT_0__VCONN_MON_P1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__VCONN_MON_P1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__VCONN_MON_P2_net;
	wire [0:0] tmpFB_0__VCONN_MON_P2_net;
	wire [0:0] tmpIO_0__VCONN_MON_P2_net;
	wire [0:0] tmpINTERRUPT_0__VCONN_MON_P2_net;
	electrical [0:0] tmpSIOVREF__VCONN_MON_P2_net;

	cy_psoc3_pins_v1_10
		#(.id("fa8bda82-7d12-431c-aac2-fffa0b841f7c"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		VCONN_MON_P2
		 (.oe(tmpOE__VCONN_MON_P2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__VCONN_MON_P2_net[0:0]}),
		  .analog({Net_2249}),
		  .io({tmpIO_0__VCONN_MON_P2_net[0:0]}),
		  .siovref(tmpSIOVREF__VCONN_MON_P2_net),
		  .interrupt({tmpINTERRUPT_0__VCONN_MON_P2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__VCONN_MON_P2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__VBUS_OVP_TRIP_P1_net;
	wire [0:0] tmpFB_0__VBUS_OVP_TRIP_P1_net;
	wire [0:0] tmpIO_0__VBUS_OVP_TRIP_P1_net;
	wire [0:0] tmpINTERRUPT_0__VBUS_OVP_TRIP_P1_net;
	electrical [0:0] tmpSIOVREF__VBUS_OVP_TRIP_P1_net;

	cy_psoc3_pins_v1_10
		#(.id("a4205eff-47dd-4d4e-b79b-ffe65f5ef820"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		VBUS_OVP_TRIP_P1
		 (.oe(tmpOE__VBUS_OVP_TRIP_P1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__VBUS_OVP_TRIP_P1_net[0:0]}),
		  .io({tmpIO_0__VBUS_OVP_TRIP_P1_net[0:0]}),
		  .siovref(tmpSIOVREF__VBUS_OVP_TRIP_P1_net),
		  .interrupt({tmpINTERRUPT_0__VBUS_OVP_TRIP_P1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__VBUS_OVP_TRIP_P1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__VBUS_OVP_TRIP_P2_net;
	wire [0:0] tmpFB_0__VBUS_OVP_TRIP_P2_net;
	wire [0:0] tmpIO_0__VBUS_OVP_TRIP_P2_net;
	wire [0:0] tmpINTERRUPT_0__VBUS_OVP_TRIP_P2_net;
	electrical [0:0] tmpSIOVREF__VBUS_OVP_TRIP_P2_net;

	cy_psoc3_pins_v1_10
		#(.id("5ddb9faa-2032-447c-a2ec-130b16b1e8e6"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		VBUS_OVP_TRIP_P2
		 (.oe(tmpOE__VBUS_OVP_TRIP_P2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__VBUS_OVP_TRIP_P2_net[0:0]}),
		  .io({tmpIO_0__VBUS_OVP_TRIP_P2_net[0:0]}),
		  .siovref(tmpSIOVREF__VBUS_OVP_TRIP_P2_net),
		  .interrupt({tmpINTERRUPT_0__VBUS_OVP_TRIP_P2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__VBUS_OVP_TRIP_P2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    TCPWM_P4_v2_0_2 HPD_Timer (
        .stop(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(1'b1),
	...
	wire [0:0] tmpOE__HPD_P2_net;
	wire [0:0] tmpFB_0__HPD_P2_net;
	wire [0:0] tmpIO_0__HPD_P2_net;
	wire [0:0] tmpINTERRUPT_0__HPD_P2_net;
	electrical [0:0] tmpSIOVREF__HPD_P2_net;

	cy_psoc3_pins_v1_10
		#(.id("90c7ee30-6d07-4322-9b8e-badf497401f3"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		HPD_P2
		 (.oe(tmpOE__HPD_P2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__HPD_P2_net[0:0]}),
		  .io({tmpIO_0__HPD_P2_net[0:0]}),
		  .siovref(tmpSIOVREF__HPD_P2_net),
		  .interrupt({tmpINTERRUPT_0__HPD_P2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__HPD_P2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("37196fde-9897-483e-9fe7-2c42e23fddc0"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
