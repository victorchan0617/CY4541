 ...
 * by the firmware stack. The contents of this file are expected to remain
 * unchanged for a given CCG part.@}
 *
 *******************************************************************************
 *
...
#define CCG_APP_PRIORITY_ROW_NUM                (CY_FLASH_NUMBER_ROWS - 4)
...
#define CCG_IMG1_LAST_FLASH_ROW_NUM             (0x0FF)
